...
import {PhoneCodeDomainEntity} from "./phoneCode.domain.entity.ts";
import {PhoneCodeRepositoryEntity} from "./phoneCode.repository.entity.ts";
import {StateServiceEntity} from "../../location/state/state.service.entity.ts";
import {type StateEntity} from "../../location/state/state.domain.entity.ts";

export class PhoneCodeServiceEntity extends EntityServiceBase<PhoneCodeDomainEntity, PhoneCodeRepositoryEntity> {
    static RepositoryClass = PhoneCodeRepositoryEntity;
    protected readonly DomainClass = PhoneCodeDomainEntity;
