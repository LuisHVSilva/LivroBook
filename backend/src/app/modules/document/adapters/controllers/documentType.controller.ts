...
export class DocumentTypeController extends ControllerBase<DocumentTypeAbstractControllerBaseType> implements IDocumentTypeController {
    constructor(
        @inject("ICreateDocumentTypeUseCase") protected readonly createDocumentTypeUseCase: ICreateDocumentTypeUseCase,
        @inject("IFindDocumentTypeByIdUseCase") protected readonly findDocumentTypeByIdUseCase: IFindDocumentTypeByIdUseCase,
        @inject("IFindDocumentTypesUseCase") protected readonly findDocumentTypesUseCase: IFindDocumentTypesUseCase,
        @inject("IUpdateDocumentTypeUseCase") protected readonly updateDocumentTypeUseCase: IUpdateDocumentTypeUseCase,
        @inject("IDeleteDocumentTypesUseCase") protected readonly deleteDocumentTypesUseCase: IDeleteDocumentTypesUseCase,
    ) {
