...
export function isAbelToAccessMiddleware(canUpdateOwnData: boolean = false) {
    return async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            if (canUpdateOwnData) {
                ...
                const isAdmin = decoded.userTypeId === adminUserType.id;
            ...
            if (decoded.userTypeId !== adminUserType.id) {
